...
public class AjsNBDMyProfilePage extends CMAbstractPage<AjsNBDMyProfilePage>{
	...
	public AjsNBDMyProfilePage verify_error_for_different_new_and_verifynew_password(String msg){
	...
	public AjsNBDMyProfilePage verify_error_for_password_not_meeting_requirement(String msg){
		return verify_element_by_text(password_not_meeting_requirement, msg);
}
   // verify wrong existing password entry
	public AjsNBDMyProfilePage verify_error_for_wrong_existing_password(String msg){
...
//Old Kiosk---------------------------------------------------------
  ...
  // Click on Action menu dropdown in NBD
	public	AjsNBDMyProfilePage click_action_menu(){
		return click_button(action_menu);
}
		
	
  // Click on Action menu dropdown in NBD
	public	AjsNBDMyProfilePage click_configure_signin_machine(){
		return click_button(configure_sign_in_machine);
}
  // select location for signin
	public	AjsNBDMyProfilePage select_location_for_old_kiosk(String location){
		return select_by_name(select_location, location);
}
	
  // select location for signin
	public	AjsNBDMyProfilePage select_entry_point_for_old_kiosk(String poe){
		return select_by_name(select_entry_point, poe);
}
	
  // click vendormate sign in link
	public	AjsNBDMyProfilePage click_vendormate_sign_in_link(){
		return click_link(vendormate_signin_link);
}
	
 // Click unconfigure signin machine link
	public	AjsNBDMyProfilePage click_unconfigure_signin_machine(){
		return click_button(unconfigure_sign_in_machine);
}
	
 // Click Unconfigure button
	public	AjsNBDMyProfilePage click_unconfigure_button(){
