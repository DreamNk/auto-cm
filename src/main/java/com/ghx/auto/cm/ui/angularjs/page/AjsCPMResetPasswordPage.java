...
public class AjsCPMResetPasswordPage extends CMAbstractPage<AjsCPMResetPasswordPage> {
	...
	public AjsCPMResetPasswordPage click_reset_button(){
		return click_button(reset_password_button);
	}

	public AjsCPMResetPasswordPage verify_invalid_exisisting_password_error_msg(String error_msg){
		return verify_element_by_text(invalid_exisisting_password_error_msg, error_msg);
	}
	
	public AjsCPMResetPasswordPage verify_minimum_password_requirement_error_msg_in_new_password(String error_msg){
		return verify_element_by_text(minimum_password_requirement_error_msg, error_msg);
	}
	
	public AjsCPMResetPasswordPage verify_password_is_required_error_msg(String error_msg){
		return verify_element_by_text(password_is_required_error_msg, error_msg);
	}
	
	public AjsCPMResetPasswordPage verify_password_requirement_instruction_msg(String msg){
		return verify_element_by_text(password_requirement_instruction_msg, msg);
	}
	
	public AjsCPMResetPasswordPage verify_new_password_error_msg(String msg){
		return verify_element_by_text(verify_new_password_error_msg, msg);
	}
	
	public AjsCPMResetPasswordPage enter_existing_password(String msg){
		return enter(existing_password_textbox, msg);
	}
	
	public AjsCPMResetPasswordPage enter_new_password(String msg){
